...
TEST_CASE( "Clase comparator reverse compare correctamente", "[DbComparatorReverse]" ) {
	DbComparatorReverse comparator;
	...
	SECTION( "Comparaciones de mayor/menor" ) {
		...
		REQUIRE( comparator.Compare(Slice("hola/pepe/"), Slice("hola/pepe/asdasd")) < 0);
		REQUIRE( comparator.Compare(Slice("hola/pepe/asdasd"), Slice("hola/pepe/")) > 0);
	}
}
