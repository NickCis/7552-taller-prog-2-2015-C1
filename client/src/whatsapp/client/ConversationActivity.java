...
public class ConversationActivity extends Activity implements ServerResultReceiver.Listener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		/*
		 ...
		 //if (dbH.fetchConversation(new ConversationEntity(getIntent().getExtras().getBundle("whatsapp.client.MainActivity.data").getInt("conversationId"))) != null)
		 if (dbH.fetchConversation(new ConversationEntity(getIntent().getStringExtra("id"))) != null)
