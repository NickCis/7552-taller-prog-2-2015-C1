...
public class DialogFactory {
	...
	/**
	 * Crea un dialogo con un infinite progress en un contexto dado con un
	 * mensaje a eleccion
	 *
	...
	/**
	 * Crea un dialogo con un boton de aceptar, el dialogo se crea en un
	 * contexto dado, con un titulo y un mensaje, cuando se aprete aceptar se va
	 * a dirigir a la activity definida en cls
	 *
	...
	public static AlertDialog createOkCancelDialog(final Context ctx, String title, String msg, OnClickListener listener) {
		AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(ctx);
		alertDialogBuilder.setMessage(msg);
		alertDialogBuilder.setTitle(title);
		alertDialogBuilder.setPositiveButton("Ok", listener);
		alertDialogBuilder.setNeutralButton("Cancel", new OnClickListener() {
	...
	/**
	 * Crea un dialogo con un boton de aceptar, el dialogo se crea en un
	 * contexto dado, con un titulo y un mensaje
	 *
	 * @param ctx contexto donde se genera el dialogo
	 * @param title titulo del dialogo
	 * @param msg mensaje a mostrar dentro del dialogo
	...
	public static AlertDialog createInputDialog(final Context ctx, String title, OnClickListener listenerOk,EditText edit){
		AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(ctx);
		alertDialogBuilder.setTitle(title);
